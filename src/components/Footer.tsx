        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center">
              <span className="text-xl font-bold text-slate-900">InvoicePatch</span>
            </div>
            <p className="mt-2 text-xs leading-5 text-slate-500">
              &copy; 2024 InvoicePatch. Built for Canadian contractors.
            </p>
            <div className="mt-4 flex space-x-6 text-xs text-slate-500">
              ...
              <a href="#" className="hover:text-slate-700 transition-colors duration-200">Contact</a>
            </div>
          </div>
        </div>
      </div>
